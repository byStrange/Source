$(function() {
        ...
        for (let i = 0; i < s.length; i++) {
            s.eq(i).click(function(argument) {
                // body...
                $('.text').eq(i).slideToggle(500);
                $('.title').eq(i).toggleClass('tt');
                $('	span').eq(i).toggleClass('rotate')
            })
        }
